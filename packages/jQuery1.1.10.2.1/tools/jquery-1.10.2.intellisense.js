...
intellisense.annotate(jQuery.fn, {
  ...
  'context': function() {
    /// <summary>Deprecated in jQuery 1.10 (see jQuery.support). The DOM node context originally passed to jQuery(); if none was passed then context will likely be the document.</summary>
    /// <returns type="Element" />
  },
  'css': function() {
    /// <signature>
